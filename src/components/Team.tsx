        ...
        <div>
          ...
          <div className="">
            <Card
              ...
              link="https://koinxapp.vercel.app/_next/image?url=%2FteamMembers%2FJohnSmith.png&w=128&q=75"
            />
            <Card
              name="Elina Williams"
              des="Designation here"
              link="https://koinxapp.vercel.app/_next/image?url=%2FteamMembers%2FElinaWilliams.png&w=128&q=75"
            />
            <Card
              name="John Smith"
              des="Designation here"
              link="https://koinxapp.vercel.app/_next/image?url=%2FteamMembers%2FChandlerBing.png&w=128&q=75"
            />
          </div>
        </div>
      </div>
